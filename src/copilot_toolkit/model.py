...
class OutputData(BaseModel):
    ...
    def render_output_files(self, console: Console, output_prefix: str = ".project/"):
        ...
        for file_path, content in self.output.items():
            ...
            size_display = f"{content_size / 1024:.2f} KB" if content_size > 1024 else f"{content_size} bytes"
            ...
            try:
                ...
                files_table.add_row(file_path_with_prefix, "[green]✓ Created[/green]", size_display)
            except Exception as e:
                files_table.add_row(file_path_with_prefix, f"[red]✗ Error: {str(e)}[/red]", size_display)
